    ...
    <div className="w-full">
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 right-0 h-24 z-20 flex items-center justify-between p-4 bg-gradient-to-b from-black/50 to-transparent">
           ...
           <div className="flex items-center space-x-2">
              <button className="flex items-center justify-center h-10 w-10 rounded-full bg-black/40 text-white hover:bg-black/60 transition-colors">
                 <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-t-3xl -mt-12 relative p-6 lg:p-8">
        <div className="max-w-3xl mx-auto">
            <span className="inline-block bg-blue-100 dark:bg-blue-900/60 text-blue-600 dark:text-blue-300 text-xs font-semibold px-3 py-1 rounded-full mb-4">{article.category}</span>
            <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white mb-4 leading-tight">{article.title}</h1>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed">
             ...
             {article.sources && article.sources.length > 0 && (
              <div className="mt-12 pt-6 border-t border-gray-200 dark:border-gray-700">
                <h4 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase mb-3">Source</h4>
